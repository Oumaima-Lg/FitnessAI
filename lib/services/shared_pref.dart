...
class SharedpreferenceHelper {
  ...
  Future<bool> saveUserAge(String age) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.setString(userAgeKey, age);
  }
  ...
  Future<bool> saveUserWeight(String weight) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.setString(userWeightKey, weight);
  }

  Future<bool> saveUserHeight(String height) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.setString(userHeightKey, height);
  }
