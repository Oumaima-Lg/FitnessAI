...
class _GoPageState extends State<GoPage> {
  ...
  String get formattedTime {
    final minutes = (seconds ~/ 60).toString().padLeft(2, '0'); // hadi katzid 0 flbdya
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
                ...
                Center(
                  child: Container(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(23),
                      child: Image(
                        image: AssetImage(widget.activity.videoDemonstartionUrl!),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
          ...
          SizedBox(height: 10),
          Icon(
            Icons.watch_later_outlined, color: Color(0xFF983BCB), size: 54,
          ),
          SizedBox(height: 10),
          Stack(
            children: [
              Text(
                formattedTime,
                style: titleTextStyle(fontSize: 36, fontWeight: FontWeight.w600).copyWith(
                  foreground: Paint()
